    ...
    return (
        ...
        <div onClick={appclick} className='main' >
            ...
            <div className="section" ref={whereTo} >
                ...
                <div className="logos">
                    <a target="_blank" rel="noopener noreferrer" href="https://instagram.com/verter_music">
                        <FontAwesomeIcon icon={faInstagram} />
                    </a>
                    <a target="_blank" rel="noopener noreferrer" href="https://open.spotify.com/artist/6H8wsbtJTIAsvbKysRvVFO?si=68wVdV44RdCBUzx3LfZAcA">
                        <FontAwesomeIcon icon={faSpotify} />
                    </a>
                    <a target="_blank" rel="noopener noreferrer" href="https://music.apple.com/us/artist/verter-music/1360898688">
                        <FontAwesomeIcon icon={faApple} />
                    </a>

                    <a target="_blank" rel="noopener noreferrer" href="https://play.google.com/store/music/artist/Verter_Music?id=At3s3lycrhahb7cwgjw5niptfn4">
                        <FontAwesomeIcon icon={faGooglePlay} />
                    </a>
                    <a target="_blank" rel="noopener noreferrer" href="https://soundcloud.com/the_verter">
